...
class SemanticSamAutomaticMaskGenerator:
    ...
    def _process_batch(
        ...
        batch_inputs = [data]
        # 这个没懂
        # predictor 为 basemodel，model 为 GeneralizedMaskDINO
        # evaluate_demo 输出预测结果，掩码，iou分数，掩码特征，多尺度掩码特征
        ...
        # 没懂
        # Compress to RLE
        # 因为layer为0，所以 crop_box为0，0，1024，1024，此函数没有任何影响
