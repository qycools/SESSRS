...
def train_aug(img, mask):
    aug = Compose([RandomHorizontalFlip(prob=0.5), RandomVerticalFlip(prob=0.5),RandomScale(scale_list=[0.5, 0.75, 1.0, 1.25, 1.5], mode='value'),
...
class UrbanDataset(Dataset):
    def __init__(self, data_root='data/Urban/test', mode='val', img_dir='images', mask_dir='masks',
...
train_dataset = UrbanDataset(data_root='data/Urban/train', mode='train', transform=train_aug)

val_dataset = UrbanDataset(data_root='data/Urban/test',transform=val_aug)
