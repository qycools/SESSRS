...
def parse_args():
    ...
    parser.add_argument("--mask-dir", default="data/LoveDA/Train/Urban/masks_png")
    parser.add_argument("--output-mask-dir", default="data/LoveDA/Train/Urban/masks_png_convert")
